...
export default function HeaderButtons({ handleOpenMenu }: HeaderButtonsProps) {
  ...
  return (
    <nav className='flex lg:gap-2 lg:ml-3 flex-col items-start lg:flex-row'>
      <div className='flex w-full p-4 justify-between items-center lg:hidden border-b border-white/15'>
        <div className='max-w-[80px]'>
          <Logo />
        </div>
        <button onClick={handleOpenMenu} className='text-white/90'>
          <svg

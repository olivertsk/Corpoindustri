    ...
    <div className='container mx-auto grid grid-cols-3 gap-8'>
      ...
      <div className='hidden md:flex justify-center items-center bg-gradient-to-b from-[#DD2A7B] to-[#515BD4] rounded-md'>
        <div className='flex flex-col items-center justify-center'>
          ...
          >
            <g fill='none'>
              <rect
                width='256'
                height='256'
                fill='url(#IconifyId19431e3c58834a42b2)'
                rx='60'
              />
              <rect
                width='256'
                height='256'
                fill='url(#IconifyId19431e3c58834a42b3)'
                rx='60'
              />
              <path
                fill='#fff'
              ...
              <defs>
                <radialGradient
                  id='IconifyId19431e3c58834a42b2'
                  cx='0'
                  cy='0'
                  r='1'
                ...
                <radialGradient
                  id='IconifyId19431e3c58834a42b3'
                  cx='0'
                  cy='0'
                  r='1'
          ...
          <h4 className='text-white font-bold mt-4 text-2xl'>@Corpoindustri</h4>
        </div>
      </div>
    </div>
  );

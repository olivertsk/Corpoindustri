...
export const containerStyles = 'bg-white p-4 lg:p-16 rounded-md shadow-lg';
...
export const tableHeadStyles = `text-center bg-primary py-2 text-white`;
export const tableStyles = `w-full rounded-md overflow-hidden bg-white`;
export const tableBodyStyles = `text-center border-b-[1px] py-3`;
